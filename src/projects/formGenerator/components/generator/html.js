...
export function dialogWrapper(str) {
    ...
    <div slot="footer">
      ...
      <el-button v-preventReClick="2000" type="primary" @click="handelConfirm">确定</el-button>
    </div>
  </el-dialog>`
}
...
function buildFromBtns(scheme, type) {
    ...
    if (scheme.formBtns && type === 'file') {
        str = `<el-form-item size="large">
          <el-button v-preventReClick="2000" type="primary" @click="submitForm">提交</el-button>
          <el-button v-preventReClick="2000" @click="resetForm">重置</el-button>
        </el-form-item>`
        if (someSpanIsNot24) {
            str = `<el-col :span="24">
          ${str}
...
function buildElUploadChild(scheme) {
    ...
    else list.push(`<el-button v-preventReClick="2000" size="small" type="primary" icon="el-icon-upload">${config.buttonText}</el-button>`)
