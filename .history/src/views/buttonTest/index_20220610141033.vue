  ...
  <div class="flex flex-col gap-12 bg-red-300" @click="handlerMouseover">
    ...
    <main>
      <article>
        <header>头部</header>
        <section>
          <popover-custom ref="poperRef" v-model:visible='visible' placement="top-start" :width="200" trigger="click">
            <template #header>
...
type A = instance popoverCustom
const poperRef: Ref<typeof popoverCustom | null> = ref(null)
