...
type IElTag = 'el-input' | 'el-input-number' | 'el-select' | 'el-radio-group' | 'el-checkbox-group' | 'el-cascader' | 'el-time-picker' | 'el-date-picker' | 'el-rate'
...
function renderForm(h) {
  ...
  console.log(this[formConfCopy.formModel], 'renderForm')
...
function setValue(event: string, config, scheme) {
  ...
  this.$nextTick(() => {
    ...
    console.log(config.defaultValue, 'defaultValue')
...
function buildListeners(scheme) {
  ...
  listeners.input = (event: string) => setValue.call(this, event, config, scheme)
...
export default defineComponent({
  ...
  data() {
    const data = {
      formConfCopy: cloneDeep(this.formConf),
  ...
  methods: {
    ...
    buildRules(componentList: any, rules: any) {
      componentList.forEach((cur: any) => {
        ...
        if (Array.isArray(config.regList)) {
          ...
          rules[cur.__vModel__] = config.regList.map((item: { pattern: any; trigger: string | undefined }) => {
    ...
    resetForm() {
      this.formConfCopy = cloneDeep(this.formConf)
